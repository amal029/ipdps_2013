...
mesh. Finally, every CPU core in this setup runs at
\textcolor{red}{2GHz: correct?} and has a vector capacity of 64, i.e.,
64 floating point elements can be processed in a SIMD at
once. Similarly, all GPUs run at \textcolor{red}{700MHz: is this
  correct??}  and can perform 4096 floating point operations in a SIMD
fashion. The application set is varied in the exact same manner as the

...
\begin{figure*}[t!]
  \centering
  \subfigure[CPU]{
    \includegraphics[angle=0, scale=0.41]{./figures/cpu}
    \label{fig:cpu}
  }
  \subfigure[GPU]{
    \includegraphics[angle=0, scale=0.41]{./figures/gpu}
    \label{fig:gpu}
  }
  \subfigure[Serial]{
    \includegraphics[angle=0, scale=0.41]{./figures/serial}
    \label{fig:serial}
  }
  \subfigure[Parallel]{
    \includegraphics[angle=0, scale=0.41]{./figures/parallel}
    \label{fig:parallel}
  }
  \subfigure[Communication Intensive Applications]{
    \includegraphics[angle=0, scale=0.41]{./figures/comm}
    \label{fig:comm}
  }
  \subfigure[Overall]{
    \includegraphics[angle=0, scale=0.41]{./figures/overall}
    \label{fig:overall}
  }
  \caption{Experimental Results on random application graphs}
  \label{fig:exp-res}
\end{figure*}

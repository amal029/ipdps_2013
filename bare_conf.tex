...
\footnotetext[\value{footnote}]{Ellipses represent data stores. Rectangles
  ...
  figure. Dashed arrows represent commuication between data stores and
...
\begin{figure}[ht]
  ...
  \caption{The task graph for the Jacobi example $^{\decimal{footnote}}$}
  \label{fig:1}
\end{figure}
...
% >>>>>>> 42ffdc746763a12ade4dfcf6d9c9091b66029af3
    \\s.t., d = (i,k), k \neq i, \forall k

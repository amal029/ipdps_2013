...
\begin{abstract}
  ...
  architectures. Given a hetrogeneous HPC cluster with varying compute
...
maximum throughput. Moreover, our HMAP framework is also deals with the
...
% which allows the application writers to design and tune their
% applications to extract parallelism. We also consider communication
% along application and underlying architecture edges, which when combined
% with the filter and data parallelism gives a better estimate of the
% application period than the currently described research literature
